...
class ChangeLanguageAPIView(APIView):
    ...
    def patch(self, request):
        ...
        if request.data["language"] is None or request.data["language"] not in [
            "en",
            "th",
        ]:
...
class ResetPasswordAPIView(APIView):
    ...
    def post(self, request):
        ...
        resetpasswordtoken = ResetPasswordToken.objects.filter(
            uuidToken=payload["uuidToken"]
        ).first()
